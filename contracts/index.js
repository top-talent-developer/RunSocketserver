...
const wallet = new ethers.Wallet(process.env.PRIVATEKEY, providers[supportChainId]);
...
const storeContract = new ethers.Contract(Contrats.store.address, Contrats.store.abi, wallet);
